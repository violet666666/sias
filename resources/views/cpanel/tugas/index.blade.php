      	...
      	<div class="card">
          	<div class="card-header">
          		<div style="float: left;">
          			<a href="#" value="{{ route('cpanel.create.tugas') }}" class="btn btn-success modalCreate" title="Buat Tugas" data-toggle="modal" data-target="#modalCreate"><i class="fas fa-user-plus"></i> &nbsp;Buat Tugas</a>
          		</div>
					...
					<tbody>
						...
						@foreach($data as $value)
							<tr>
								...
								<td class="center">
									<a href="#" value="{{ route('cpanel.edit.tugas', $value->id) }}" class="btn btn-warning btn-sm modalEdit" title="Edit Kelas" data-toggle="modal" data-target="#modalEdit"><span class="fas fa-pencil-alt"></span></a>
								</td>
							</tr>
						@endforeach
					</tbody>
