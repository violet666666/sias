                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="email" type="email" placeholder="Email" name="email" required value="{{ old('email') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    <p class="center">Remember your password? <a href="{{ route('login') }}" style="color: #ff4f70!important;"> Sign In</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
