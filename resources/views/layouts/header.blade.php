                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img style="width: 55px; height: auto;" src="{{ asset('images/icon.png') }}" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img style="width: 55px; height: auto;" src="{{ asset('images/icon.png') }}" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="ml-2 d-none d-lg-inline-block">
                                    <span>Halo,</span> <span class="text-dark">{{ Auth::user()->name }}</span> <i data-feather="chevron-down" class="svg-icon"></i>
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item modalProfile" title="Profile User" href="" value="" data-toggle="modal" data-target="#modalProfile">
